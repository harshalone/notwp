        ...
        <main className="pt-20 px-8 pb-8">
          ...
          <div className="bg-white rounded-lg border border-stone-200 p-12">
            <div className="text-center">
              ...
              <h2 className="text-xl font-semibold text-stone-900 mb-2">No pages yet</h2>
              <p className="text-stone-600 mb-6">Create your first static page like About, Contact, etc.</p>
